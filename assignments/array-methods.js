...
let largeShirts = runners.filter(filteredLargeShirts => {
    let shirtSize = filteredLargeShirts.shirt_size === 'L'
    return shirtSize
});
...
let ticketPriceTotal = runners.reduce((donationCount, Remington) => {
    console.log(donationCount)
    console.log(Remington)
    return Remington.donation + donationCount
}, 0);
